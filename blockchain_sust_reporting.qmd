...
Results from this [link](https://www.webofscience.com/wos/woscc/summary/4a9eba5d-0f40-46e6-8bae-582283bd4e01-7ab16fa0/relevance/1)
...
M <- convert2df(file = "blockchain/blockchain_sustainability_reporting.bib", dbsource = "isi", format = "bibtex")
...
```{r}
#H index
indices <- Hindex(M, field = "author", elements="ALOFI A", sep = ";", years = 10)
```
